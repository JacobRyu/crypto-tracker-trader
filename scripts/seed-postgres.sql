...
(1, 1, 'ethereum', '0x742d35Cc6634C0532925a3b844Bc9e7595f2bD38', 'Main ETH Wallet', NOW() - INTERVAL '25 days', NOW()),
(2, 1, 'polygon', '0x742d35Cc6634C0532925a3b844Bc9e7595f2bD19', 'Polygon Wallet', NOW() - INTERVAL '20 days', NOW()),
...
(1, 1, 'ethereum', '0x0000000000000000000000000000000000000000', 'ETH', 1.50000000, NOW()),
(2, 1, 'ethereum', '0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48', 'USDC', 5000.00000000, NOW()),
(3, 2, 'polygon', '0x0000000000000000000000000000000000001010', 'MATIC', 20.00000000, NOW()),
(4, 3, 'ethereum', '0x0000000000000000000000000000000000000000', 'ETH', 0.50000000, NOW()),
(5, 3, 'ethereum', '0x6B175474E89094C44Da98b954EedeAC495271d0F', 'DAI', 1000.00000000, NOW()),
(6, 4, 'ethereum', '0x0000000000000000000000000000000000000000', 'ETH', 2.00000000, NOW())
ON CONFLICT (id) DO UPDATE SET
...
(1, 1, NOW() - INTERVAL '7 days', 12500.00000000),
(2, 1, NOW() - INTERVAL '1 day', 13200.00000000),
(3, 2, NOW() - INTERVAL '3 days', 8500.00000000),
(4, 3, NOW() - INTERVAL '2 days', 4500.00000000)
ON CONFLICT (id) DO UPDATE SET
...
(7, 4, 'ETH', 2.00000000, 2000.00000000)
ON CONFLICT (id) DO UPDATE SET
...
-- 9. 取引所残高テーブル
-- =====================================================
INSERT INTO exchange_balances (id, user_id, credential_id, asset, free, locked, total, created_at, updated_at) VALUES
(1, 1, 1, 'BTC', 0.50000000, 0.00000000, 0.50000000, NOW() - INTERVAL '10 minutes', NOW()),
(2, 1, 1, 'USDT', 10000.00000000, 5000.00000000, 15000.00000000, NOW() - INTERVAL '10 minutes', NOW()),
(3, 1, 1, 'ETH', 2.00000000, 0.50000000, 2.50000000, NOW() - INTERVAL '10 minutes', NOW()),
(4, 2, 2, 'ETH', 2.00000000, 0.00000000, 2.00000000, NOW() - INTERVAL '30 minutes', NOW()),
(5, 2, 2, 'BTC', 0.10000000, 0.00000000, 0.10000000, NOW() - INTERVAL '30 minutes', NOW()),
(6, 1, 3, 'SOL', 10.00000000, 0.00000000, 10.00000000, NOW() - INTERVAL '1 hour', NOW())
ON CONFLICT (id) DO UPDATE SET
  free = EXCLUDED.free,
...
-- 10. DeFiポジションテーブル
-- =====================================================
INSERT INTO defi_positions (id, wallet_id, protocol, pool_address, token0_symbol, token1_symbol, token0_amount, token1_amount, usd_value, created_at, updated_at) VALUES
(1, 1, 'uniswap-v3', '0x88e6a0c2ddd26feeb64f039a2c41296fcb3f5640', 'ETH', 'USDC', 1.50000000, 5000.00000000, 10250.00000000, NOW() - INTERVAL '1 hour', NOW()),
(2, 3, 'aave-v3', NULL, 'USDC', NULL, 5000.00000000, NULL, 5000.00000000, NOW() - INTERVAL '2 hours', NOW()),
(3, 3, 'lido', NULL, 'stETH', NULL, 0.50000000, NULL, 1750.00000000, NOW() - INTERVAL '3 hours', NOW()),
(4, 4, 'uniswap-v3', '0x88e6a0c2ddd26feeb64f039a2c41296fcb3f5640', 'ETH', 'DAI', 2.00000000, 7000.00000000, 14000.00000000, NOW() - INTERVAL '4 hours', NOW())
ON CONFLICT (id) DO UPDATE SET
...
BEGIN
  ...
  RAISE NOTICE ' defi_positions: 4件';
END $$;
